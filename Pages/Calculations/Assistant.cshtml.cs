...
public class AssistantModel : PageModel
{
    ...
    private readonly IAssistantCalculator _calculator;
    private readonly UserManager<ApplicationUser> _userManager;

    public AssistantModel(ApplicationDbContext db, IAssistantCalculator calculator, UserManager<ApplicationUser> userManager)
    {
        _db = db;
    ...
    public List<AssistantCalculation> History { get; set; } = new();
    ...
    public async Task<IActionResult> OnPostSaveAsync()
    {
        ...
        _db.AssistantCalculations.Add(new AssistantCalculation
        {
            UserId = userId,
    ...
    {
        var userId = _userManager.GetUserId(User)!;
        History = await _db.AssistantCalculations
