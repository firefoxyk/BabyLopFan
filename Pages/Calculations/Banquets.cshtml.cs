...
[Authorize]
public class BanquetsModel : PageModel
{
    private readonly ApplicationDbContext _db;
    private readonly IBanquetCalculator _calculator;
    private readonly UserManager<ApplicationUser> _userManager;

    public BanquetsModel(ApplicationDbContext db, IBanquetCalculator calculator, UserManager<ApplicationUser> userManager)
    {
        _db = db;
    ...
    public List<BanquetCalculation> History { get; set; } = new();
    ...
    public async Task<IActionResult> OnPostSaveAsync()
    {
        ...
        _db.BanquetCalculations.Add(new BanquetCalculation
        {
            UserId = userId,
    ...
    {
        var userId = _userManager.GetUserId(User)!;
        History = await _db.BanquetCalculations
