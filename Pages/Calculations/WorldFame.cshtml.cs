...
[Authorize]
public class WorldFameModel : PageModel
{
    private readonly ApplicationDbContext _db;
    private readonly IWorldFameCalculator _calculator;
    private readonly UserManager<ApplicationUser> _userManager;

    public WorldFameModel(ApplicationDbContext db, IWorldFameCalculator calculator, UserManager<ApplicationUser> userManager)
    {
        _db = db;
    ...
    public List<WorldFameCalculation> History { get; set; } = new();
    ...
    public async Task<IActionResult> OnPostSaveAsync()
    {
        ...
        _db.WorldFameCalculations.Add(new WorldFameCalculation
        {
            UserId = userId,
    ...
    {
        var userId = _userManager.GetUserId(User)!;
        History = await _db.WorldFameCalculations
